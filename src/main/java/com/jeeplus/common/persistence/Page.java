...
//		sb.append("</div>");
		...
		sb.append("<span class=\"page-list\">每页显示 <span class=\"btn-group dropdown\">");
		...
		sb.append("<li class=\""+getSelected(pageSize,3)+ "\"><a href=\"javascript:"+funcName+"("+pageNo+",10,'"+funcParam+"');\">10</a></li>");
		sb.append("<li class=\""+getSelected(pageSize,3)+ "\"><a href=\"javascript:"+funcName+"("+pageNo+",20,'"+funcParam+"');\">20</a></li>");
		sb.append("<li class=\""+getSelected(pageSize,3)+ "\"><a href=\"javascript:"+funcName+"("+pageNo+",50,'"+funcParam+"');\">50</a></li>");
		sb.append("<li class=\""+getSelected(pageSize,3)+ "\"><a href=\"javascript:"+funcName+"("+pageNo+",100,'"+funcParam+"');\">100</a></li>");
		sb.append("</ul>");
