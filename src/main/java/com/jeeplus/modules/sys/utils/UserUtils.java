...
public class UserUtils {
	...
	//管理员用户角色编码
	public static final String USER_SYSTEM_ROLE_ENNAME = "system";
	
	//机构管理员用户角色编码
	public static final String USER_JG_ROLE_ENNAME = "jg_system";
	
	//讲师角色编码
	public static final String USER_TEACHER_ENNAME = "teacher";
	//内训师角色编码
	public static final String USER_NX_TEACHER_ENNAME = "nx_teacher";
	//培训管理员
	public static final String USER_PX_SYSTEM_ENNAME = "px_system";
	//学员
	public static final String USER_STUDENT_ENNAME = "student";
	/**
	 * 根据ID获取用户
	 * @param id
	 * @return 取不到返回null
