 ...
 * @version 2017-03-19
 */
public class ResourceDir extends DataEntity<ResourceDir> {
	
	private static final long serialVersionUID = 1L;
	private String name;		// 目录名称
	private String sort;		// 排序
	private ResourceDir parent;		// 上级目录
	...
	public void setParent(ResourceDir parent) {
		this.parent = parent;
	}
