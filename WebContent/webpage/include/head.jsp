<%@ page contentType="text/html;charset=UTF-8" %><meta http-equiv="Content-Type" content="text/html;charset=utf-8" /><meta name="author" content="http://www.nxpt.com/"/>
...
<script src="${ctxStatic}/common/formatDate.js" type="text/javascript"></script>
<link href="${ctxStatic}/common/css/login.css" type="text/css" rel="stylesheet" />
<script type="text/javascript">var ctx = '${ctx}', ctxStatic='${ctxStatic}';</script>
<!-- webupload控件 -->

<link rel="stylesheet" type="text/css" href="${ctxStatic}/webuploader-0.1.5/webuploader.css" />
<script type="text/javascript" src="${ctxStatic}/webuploader-0.1.5/webuploader.min.js"></script>
