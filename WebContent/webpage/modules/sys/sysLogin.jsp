				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							...
							<div class="position-relative" style="width: 1000px;right: 250px;">
								<h1>
									<br/>
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text"  id="username" name="username" class="form-control required"  value="student" placeholder="用户名" onkeyup="clearPasswd();"/>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" id="password" name="password" class="form-control required" placeholder="密码" value="123456"/>
													...
													<div class="clearfix">
														...
														<sys:messageLogin content="${message}"/>
														  <br/>
                                                         <b>其他演示账号密码：</b> <br/>
                                                         <b>
                                                       		  管理员：admin/admin<br/>
                                                         	 &nbsp;&nbsp;&nbsp;用户：student/123456<br/>
                                                         	 &nbsp;&nbsp;&nbsp;电话：18710213152
                                                         </b><br/>
													</div>
