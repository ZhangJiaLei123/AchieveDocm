...
<head>
	...
	<script type="text/javascript">
		...
		function doSubmit(){//回调函数，在编辑和保存动作时，供openDialog调用提交表单。
		  if(checkCode() && validateForm.form()&&validateFormPage()){
			  $("#inputForm").submit();
			  return true;
		  }
		...
		function validateFormPage(){
			var resUrl = $("#resourceUrl").val();
			if(!resUrl){
				top.layer.alert("资源路径不能为空，请选择资源。");
				return false;
			}
			return true;
		}
...
<body>
		<form:form id="inputForm" modelAttribute="resourceInfo" action="${ctx}/resource/resourceInfo/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		   		<tr>
					<td width="80px" class="active"><label class="pull-right"><font color="red">*</font>资源名称：</label></td>
					<td >
						<form:input path="name" htmlEscape="false" maxlength="100" class="form-control required"/>
					</td>
				</tr>
				<tr>
					<td class=" active"><label class="pull-right"><font color="red">*</font>资源类别：</label></td>
					<td >
				...
				<tr>
					<td class=" active"><label class="pull-right"><font color="red">*</font>资源路径：</label></td>
					<td >
				...
				<tr>
					<td class=" active"><label class="pull-right"><font color="red">*</font>资源编号：</label></td>
					<td >
				...
				<tr>
					<td class=" active"><label class="pull-right"><font color="red">*</font>资源目录：</label></td>
					<td >
