...
<div class="head">
	<div class="row">
        ...
        <div class="nav fr" id="topA">
            ...
            <!--<a href="${pageContext.request.contextPath}/a/selectOfficeInfo">组织人员</a>-->
            ...
            <a href="${pageContext.request.contextPath}/a/sys/user/usercenter">个人中心</a>
            ...
            <a href="${pageContext.request.contextPath}/a/selectOfficeInfo">组织人员</a>
            <a href="${pageContext.request.contextPath}/a/findStudyResourse">学习资源</a>
            <a href="${pageContext.request.contextPath}/a/findMesanInfo">资料</a>
            <a href="${pageContext.request.contextPath}/a/course/tcourseInfo/list">课程</a>
            <a href="${pageContext.request.contextPath}/a/studyActivityList">学习活动</a>-->
           <!--  <a href="">数据统计</a> -->
        </div>
