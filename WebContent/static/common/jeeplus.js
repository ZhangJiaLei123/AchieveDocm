...
function openDialogView(title,url,width,height){
	...
	top.layer.open({
		...
		success: function(layero, index){
			var body = $(window.parent.document.getElementById('layui-layer-iframe'+index).contentWindow.document).find("*");;
			...
			$(window.frames["layui-layer-iframe"+index].document).find("input[@type='text']").attr("disabled",true);
			var aa;
            
			var btn = layero.find('body');
			console.log(btn);
			...
			var body = layer.getChildFrame('body', 1).html();
			var iframeWin = window[layero.find('iframe')[0]['name']];
			 console.log(body.html());
			body.find('input').attr("disabled",true);
		
			var cc = 'layui-layer-iframe' +index;
			var bb = document.frames[cc];
			bb.find('input').attr("disabled",true);
			var aa = layero.find('input');
			aa.each(function(){
